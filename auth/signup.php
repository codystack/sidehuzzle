...
if (isset($_POST['register_btn'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $query = "INSERT INTO users (firstName, lastName, email, password, accountType, phone, picture) 
  			        VALUES('$firstName', '$lastName', '$email', '$password', '$accountType', '$phone', './upload/avatar.png')";
